...
public class AboutBase64 {
    ...
    public void base64Encoding() {
        try {
            ...
            assertEquals(Base64.getEncoder().encodeToString("loremipsum".getBytes("utf-8")), Base64.getEncoder().encodeToString("loremipsum".getBytes("utf-8")));
//            assertEquals(encodedText, Base64.getEncoder().encodeToString("loremipsum".getBytes("utf-8")));
